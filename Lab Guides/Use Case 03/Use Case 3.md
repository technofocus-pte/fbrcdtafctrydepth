...
5.  To create a folder, provide a name to this
...
4.  Provide a descriptive **name** and optional
...
4.  After you sign in, select **Connect** to
...
5.  **Review and confirm** the deployment to the
